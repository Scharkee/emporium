...
public class PasswordStrength : MonoBehaviour
{
    ...
    public void AdaptPasswordStrengthMeter()
    {
        ...
        else if (passInp.text.Length >= 12)
        {
            ...
            RegisterPassText3.text = Languages.Instance.currentLanguage["password_strong"];
        ...
        else if (passInp.text.Length >= 8)
        {
            ...
            RegisterPassText3.text = Languages.Instance.currentLanguage["password_passable"];
        }
        else if (passInp.text.Length < 8)
        {
            ...
            RegisterPassText3.text = Languages.Instance.currentLanguage["password_weak"];
        }
    }
}